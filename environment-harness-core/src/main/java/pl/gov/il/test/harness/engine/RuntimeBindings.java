...
import pl.gov.il.test.harness.model.ConnectionRef;
...
final class RuntimeBindings {
    ...
    <C extends pl.gov.il.test.harness.model.RuntimeConfig, O> void attach(
    ...
    <C extends pl.gov.il.test.harness.model.RuntimeConfig, O> O operations(
        AbstractComponent<C, O> component
    ) {
