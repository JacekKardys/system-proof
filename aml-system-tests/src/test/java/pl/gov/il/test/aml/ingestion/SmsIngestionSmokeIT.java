package pl.gov.il.test.aml.ingestion;

import static org.assertj.core.api.Assertions.assertThat;

import org.junit.jupiter.api.Tag;
import org.junit.jupiter.api.Test;
import pl.gov.il.test.aml.ingestion.environment.AmlSmsEnvironment;
...
import pl.gov.il.test.harness.junit.EnvironmentTest;

/** Verifies that one SMS crosses the real container topology and is persisted. */
@EnvironmentTest(environment = AmlSmsEnvironment.class)
@Tag("docker")
@Tag("smoke")
final class SmsIngestionSmokeIT {

    @Test
    void shouldIngestAndPersistOneSms(AmlSmsEnvironment environment) {
